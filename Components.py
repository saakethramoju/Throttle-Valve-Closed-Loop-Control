...
class Tank(Volume):
    ...
    """
    def __init__(self, name, pressure, volume, density):
...
class CombustionChamber(Volume):
    ...
    """
    def __init__(self, name, pressure, volume, mixture_ratio):
        super().__init__(name, pressure, volume)
        self.MR = mixture_ratio

    def __str__(self):
        return (
            f"CombustionChamber(name={self.name}, p={self.p:.3e} Pa, "
...
class Line(Branch):
    ...
    """
    def __init__(self, name, mass_flow, length, cross_sectional_area, Cd):
...
class Valve(Branch):
    ...
    """
    def __init__(self, name, mass_flow, CdA):
        super().__init__(name, mass_flow)
        self.CdA = CdA  # m^2
